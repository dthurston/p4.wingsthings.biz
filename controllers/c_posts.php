...
class posts_controller extends base_controller {
    ...
    public function __construct() {
        ...
        if(!$this->user) {
            # Stop processing PHP at this point and provide a link to the login page
    ...
    public function p_add() {
        ...
        # I need to add some feedback about the post being added successfully here.
    ...
    public function users() {
        ...
        # and store the result array in the variable $users
    ...
    public function unfollow($user_id_followed) {
        ...
        # Send user back to the /posts/users page
        Router::redirect("/posts/users");
